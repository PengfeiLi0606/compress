...
c / anlys /
c
c number of possible types of data in the .res file - should be (and is) ndattyp
      integer mtype
      parameter ( mtype = ndattyp )
c max number of analys steps in one res file
      integer mtm
      parameter ( mtm = 10001 )
